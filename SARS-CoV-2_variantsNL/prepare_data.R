...
kiempdf = "https://www.rivm.nl/sites/default/files/2021-07/Varianten%20coronavirus%20tabel%20Nederlands%202%20juli%202021%20%282%29.pdf"  # https://www.rivm.nl/coronavirus-covid-19/virus/varianten

setwd("~/Progs/random R/SARS-CoV-2_variantsNL")

library("tabulizer") # https://www.r-bloggers.com/2019/09/pdf-scraping-in-r-with-tabulizer/ # https://support.apple.com/kb/DL1572?locale=nl_NL
library("tidyverse")
library("jsonlite")
library("data.table")
library("scales")
...
# get kiemsurveillance variant data from RIVM PDF (df: variants)
variants <- extract_tables(file = kiempdf, method="stream")
...
cases <- fromJSON("https://data.rivm.nl/covid-19/COVID-19_aantallen_gemeente_cumulatief.json")
